...
At the reviewed pre-reconciliation main on 2026-07-22, `49ee419e30f2d71524dd6fa15badf1ec4b8d0e27`, only P00-P02 are accepted and P03 is current. The C3 commit and any merge result are distinct identities requiring their own exact-head receipt; absent that receipt they do not advance acceptance. The D1-B observation, P03D, P04, P05-P11, B0, and A0 rows below are future dependency-ordered estimates even where candidate source exists; RICE never converts that source or the preserved `vB0` tag into acceptance.
...
| P03-OBS D1-B exact-artifact observation | 8 | 3 | 0.80 | 1 | 19.20 | Dependency-governed founder checkpoint: starts only after technical P03 acceptance and records Continue, Change, or Stop. |
| P03D Design consultation and plan review | 8 | 2 | 0.80 | 1.5 | 8.53 | Starts only after OBS records Continue; creates canonical design authority before P04. |
| P04 Typed React/Tauri design foundation | 8 | 2 | 0.80 | 4 | 3.20 | Starts only after P03D completes; owns Workspace/People/Health and current-surface themes, not Events/full B0. |
...
P03-OBS and P03D retain the machine-plan RICE values so the human and machine surfaces agree, but they are decision checkpoints rather than backlog items that can be pulled forward by score. D1-B authority overrides the raw `19.20`: OBS cannot start before exact technical P03 acceptance, P03D cannot start before Continue, and P04 cannot start before P03D completes.
