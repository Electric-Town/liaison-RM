...
The merged P01 stack adds one Rust application composition root shared by the CLI and Tauri, typed identity-bound workspace sessions, structured results and errors, and direct native adapter parity to the default-branch governance, product contracts, Workspace, People, Markdown, provider, profile, review, localisation, packaging, and public-site foundations. It does not yet have writer authority, recoverable operations, B0, or a supported public release.
