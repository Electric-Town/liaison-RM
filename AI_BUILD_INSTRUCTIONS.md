...
10. **P09-OKF/P09–P11 — B product:** after P06-REPAIR, add required previewable, exact-backup-first, journaled, failure-atomic, idempotent and exactly reversible People normalization and close `FG-B0-001`, then complete Directory onboarding import, Events/cohort/readiness/brief workflows, and the installed desktop experience.
